...
White Space Only values:
   col_7 column_name=last_updated_timestamp: 4 white space only values
   col_6 column_name=email: 7 white space only values
   col_5 column_name=shipping_zip: 3 white space only values
   col_8 column_name=: 10 white space only values
   col_4 column_name=unit_price: 3 white space only values
   col_1 column_name=order_date: 1 white space only values
   col_3 column_name=quantity: 3 white space only values
   col_2 column_name=product_sku: 5 white space only values

=== PROCESSING COMPLETE ===
Total rows processed: 12
Total chunks processed: 1
Processing time: 8.9244ms
...
Column 2 ('product_sku'):
  ...
  White-Space-Only values: 5 (41.67%)

Column 3 ('quantity'):
  NULL-like values: 2 (16.67%)
  Empty values: 3 (25.00%)
  White-Space-Only values: 3 (25.00%)
...
Column 6 ('email'):
  ...
  White-Space-Only values: 7 (58.33%)

Column 7 ('last_updated_timestamp'):
  NULL-like values: 1 (8.33%)
  Empty values: 3 (25.00%)
  White-Space-Only values: 4 (33.33%)

Column 8 (''):
  NULL-like values: 1 (8.33%)
  Empty values: 9 (75.00%)
  White-Space-Only values: 10 (83.33%)
...
## Example CLI input with Output on larger dataset ~1,000,000 row CSV at 529 MB (554,823,961 bytes) with a Processing time: 18.2s
...
White Space Only values:
   col_18 column_name=tagline: 847723 white space only values
   col_1 column_name=title: 12 white space only values
   col_14 column_name=original_title: 9 white space only values
   col_20 column_name=production_companies: 545291 white space only values
   col_22 column_name=spoken_languages: 424915 white space only values
   col_9 column_name=backdrop_path: 719374 white space only values
   col_11 column_name=homepage: 892670 white space only values
   col_21 column_name=production_countries: 450431 white space only values
   col_5 column_name=release_date: 194038 white space only values
   col_12 column_name=imdb_id: 465256 white space only values
   col_19 column_name=genres: 403170 white space only values
   col_15 column_name=overview: 209163 white space only values
   col_17 column_name=poster_path: 337757 white space only values
   col_23 column_name=keywords: 715813 white space only values
...
White Space Only values:
   col_9 column_name=backdrop_path: 187520 white space only values
   col_5 column_name=release_date: 31675 white space only values
   col_21 column_name=production_countries: 111332 white space only values
   col_12 column_name=imdb_id: 136555 white space only values
   col_19 column_name=genres: 105258 white space only values
   col_14 column_name=original_title: 4 white space only values
   col_20 column_name=production_companies: 137901 white space only values
   col_18 column_name=tagline: 205800 white space only values
   col_15 column_name=overview: 52092 white space only values
   col_23 column_name=keywords: 188706 white space only values
   col_11 column_name=homepage: 204336 white space only values
   col_1 column_name=title: 4 white space only values
   col_17 column_name=poster_path: 65659 white space only values
   col_22 column_name=spoken_languages: 115172 white space only values

=== PROCESSING COMPLETE ===
Total rows processed: 1225501
Total chunks processed: 2
Processing time: 18.2449026s
...
Chunk size used: 1000000 rows
Processing time: 18s 244ms
Processing rate: 67172.82 rows/second
COLUMN STATISTICS:
Column 0 ('id'):
  NULL-like values: 0 (0.00%)
  Empty values: 0 (0.00%)
...
Column 1 ('title'):
  ...
  White-Space-Only values: 16 (0.00%)
...
Column 5 ('release_date'):
  ...
  White-Space-Only values: 225713 (18.42%)
...
Column 9 ('backdrop_path'):
  ...
  White-Space-Only values: 906894 (74.00%)
...
Column 11 ('homepage'):
  ...
  White-Space-Only values: 1097006 (89.51%)

Column 12 ('imdb_id'):
  NULL-like values: 450 (0.04%)
  Empty values: 601811 (49.11%)
  White-Space-Only values: 601811 (49.11%)
...
Column 14 ('original_title'):
  NULL-like values: 3 (0.00%)
  Empty values: 13 (0.00%)
  White-Space-Only values: 13 (0.00%)

Column 15 ('overview'):
  NULL-like values: 0 (0.00%)
  Empty values: 260087 (21.22%)
  White-Space-Only values: 261255 (21.32%)
